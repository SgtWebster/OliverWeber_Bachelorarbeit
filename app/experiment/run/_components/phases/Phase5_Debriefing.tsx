...
export default function Phase5Debriefing() {
    ...
    return (
        <div className="bg-white p-5 sm:p-8 rounded-xl border border-slate-200 font-mono text-slate-800 text-center">
            ...
            <button onClick={handleExit} className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 px-8 rounded-lg">
