...
export const UpdateSessionSchema = z.object({
  ...
  mReliable: z.number().int().min(1).max(5).optional(),
  mCapable: z.number().int().min(1).max(5).optional(),
  mCompetent: z.number().int().min(1).max(5).optional(),
  mMeticulous: z.number().int().min(1).max(5).optional(),
  mEthical: z.number().int().min(1).max(5).optional(),
  mRespectable: z.number().int().min(1).max(5).optional(),
  mSincere: z.number().int().min(1).max(5).optional(),
  mBenevolent: z.number().int().min(1).max(5).optional(),
  performanceTrust: z.number().min(0).max(100).optional(),
  moralTrust: z.number().min(0).max(100).optional(),
